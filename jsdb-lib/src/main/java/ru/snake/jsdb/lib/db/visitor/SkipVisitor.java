...
public final class SkipVisitor<T> implements DbVisitor<T> {
	 ...
	 *            count
	 */
	public SkipVisitor(final DbVisitor<T> visitor, final int count) {
	...
	public String toString() {
		return "SkipVisitor [visitor=" + visitor + ", count=" + count + ", n=" + n + ", error=" + error + ", cancelled="
				+ cancelled + "]";
	}
